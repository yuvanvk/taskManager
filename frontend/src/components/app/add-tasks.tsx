        ...
        <div className="w-full pt-28">
            ...
            <div className="flex items-center bg-gray-100 py-1 px-1 rounded-lg my-4">
                <Button
                    ...
                    className={cn(`${active === "single" ? "bg-blue-600 text-white hover:bg-blue-800" : "bg-transparent text-black hover:bg-gray-200"}`,
                ...
                <Button
                    ...
                    className={cn(
                        `${active === "bulk" ? "bg-blue-600 text-white hover:bg-blue-800" : "bg-transparent text-black hover:bg-gray-200 cursor-pointer"
                        } `,
